    ...
    .should ("add a static chained method")
        ...
        [
            ...
            cls => cls
                ...
                .beforeDispatch ("before", () => s.called.push ("beforeDispatch"))
                .afterDispatch ("after", () => s.called.push ("afterDispatch"))
                .beforeFailure ("before", () => s.called.push ("beforeFailure"))
                .afterFailure ("after", () => s.called.push ("afterFailure"))
                .beforeSuccess ("before", () => s.called.push ("beforeSuccess"))
                .afterSuccess ("after", () => s.called.push ("afterSuccess"))
                .beforeComplete ("before", () => s.called.push ("beforeComplete"))
                .afterComplete ("after", () => s.called.push ("afterComplete"))
        ])
        .returnsResultOfExpr ("hostClass")
        .after (s => s.hostClass.onDispatch (() => s.called.push ("onDispatch")))
        .after (s => s.hostClass.DispatchChainedMethod.beforeDispatch ("returnVal", () => s.called.push ("returnVal") && 100))
    ...
    .should ("define an instance method that will not throw if the chain context's error property is null")
        ...
        [
            ...
            cls => cls
                ...
                .afterDispatch ("after", () => s.called.push ("afterDispatch"))
                .beforeFailure ("before", () => s.called.push ("beforeFailure"))
                .afterFailure ("after", function () { this.error = null; s.called.push ("afterFailure"); })
                .beforeSuccess ("before", () => s.called.push ("beforeSuccess"))
                .afterSuccess ("after", () => s.called.push ("afterSuccess"))
                .beforeComplete ("before", () => s.called.push ("beforeComplete"))
                .afterComplete ("after", () => s.called.push ("afterComplete"))
