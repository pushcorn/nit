...
test.plugin ("plugins.Logger", "info", { pluginArgs: [true, { timestamp: true }] })
    .should ("intercept the global logging if global is true")
        ...
        .expectingPropertyToBe ("mocks.0.invocations.1.args.0", /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}.*\[WARN].*nit.log.w$/)
        .expectingPropertyToBe ("mocks.0.invocations.2.args.0", /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}.*\[INFO].*nit.log.i$/)
        .expectingPropertyToBe ("mocks.0.invocations.3.args.0", /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}.*\[INFO].*nit.log.info$/)
        .commit ()
;
