...
test.plugin ("plugins.Logger", "info", { pluginArgs: [true, { timestamp: true }] })
    .should ("intercept the global logging if global is true")
        .given ("mesg")
        .mock ("hostClass.Logger.prototype", "writeLog")
        .after (() => nit.log ("nit.log"))
        .after (() => nit.log.w ("nit.log.w"))
        .after (() => nit.log.i ("nit.log.i"))
        .after (() => nit.log.info ("nit.log.info"))
        .returns ()
        .expectingPropertyToBe ("mocks.0.invocations.0.args.0", /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}.*\[INFO].*mesg$/)
        .expectingPropertyToBe ("mocks.0.invocations.1.args.0", /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}.*\[LOG].*nit.log$/)
        .expectingPropertyToBe ("mocks.0.invocations.2.args.0", /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}.*\[WARN].*nit.log.w$/)
        .expectingPropertyToBe ("mocks.0.invocations.3.args.0", /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}.*\[INFO].*nit.log.i$/)
        .expectingPropertyToBe ("mocks.0.invocations.4.args.0", /^\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}.*\[INFO].*nit.log.info$/)
        .commit ()
;
