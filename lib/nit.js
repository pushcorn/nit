...
nit
    ...
    .constant ("REGISTRY", {})
    .staticMethod ("get", function (className)
    {
        return this.REGISTRY[nit.is.func (className) ? className.name : className];
    })
    ...
    .construct (function ()
    {
        nit.ComponentDescriptor.REGISTRY[this.className] = this;
    })
...
nit.dpvs (nit,
{
    ...
    lookupComponent: function (subdir, name, superclass)
    {
        ...
        if (!nit.is.subclassOf (cls, nit.lookupClass (superclass)))
        {
