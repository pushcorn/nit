...
nit.dpvs (nit,
{
    ...
    require: function (path, optional)
    {
        ...
        {
            return isClass && nit.CLASSES[path] || REQUIRE_CACHE[file];
        }
        ...
        if (nit.is.func (obj))
        {
            ...
            if (obj instanceof Promise)
            {
                obj.then (function (obj)
                {
                    ...
                    resolve (isClass && nit.CLASSES[path] || obj);
                });
            }
            else
            {
...
nit.UNEXPECTED_ERROR_EVENTS.forEach (event =>
    process
        .removeListener (event, nit.handleException)
