...
nit.dpvs (nit,
{
    ...
    ,
    initCommandAdapters: nit.memoize (function ()
    {
        nit.listComponents ("commandadapters")
            .map (a => a.class.registerCommands ())
        ;
    ...
    {
        return nit.initCommandAdapters ()
            .listComponents ("commands", returnNames)
        ;
    }
    ,
        ...
        .push (function ()
        {
            if (nit.CLI_MODE)
            {
                if (nit.COMPLETION_MODE)
                {
                    ...
                    nit.listComponents ("compgen.completers").map (d => d.class);
