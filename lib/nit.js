...
nit.dpvs (nit,
{
    ...
    require: function (path, optional)
    {
        ...
        if (nit.is.func (obj))
        {
            ...
            try
            {
                requiredFiles[file] = obj = nit.ns.invoke (obj);
                resolve (obj);
            }
            catch (e)
            {
    ...
    ,
    preInt: function (task)
    {
        nit.INIT_QUEUE.push (task);

        return nit;
    }
    ,
    postInt: function (task)
    {
        return nit.ready (task);
    }
    ,
    init: function ()
    {
