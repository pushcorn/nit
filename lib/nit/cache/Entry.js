module.exports = function (nit)
{
    ...
    return nit.defineClass ("nit.cache.Entry")
        ...
        .lifecycleMethod ("buildTags", null, async function (ctx) // eslint-disable-line no-unused-vars
        {
            return {};
        })
        .lifecycleMethod ("buildValue", null, async function (ctx) // eslint-disable-line no-unused-vars
        {
            return this.value;
        })
    ;
