    ...
    return (Self = nit.defineClass ("nit.test.Strategy"))
        ...
        .defineInnerClass ("Project", Project =>
        {
            Project
                ...
                {
                    nit.arrayRemove (paths, p => this.rootPackageDirs.some (dir => p.startsWith (dir)));
                })
        ...
        .defineInnerClass ("ValueValidator", "nit.test.Strategy.Validator", ValueValidator =>
        {
            ValueValidator
                ...
                .onValidate (function (strategy, value)
                {
                    ...
                    {
                        expect (result instanceof nit.Object ? result.toPojo () : result)
                            .toEqual (expected instanceof nit.Object ? expected.toPojo () : expected);
                    }
                    else
                    {
        ...
        .method ("project", function (root, excludeRootPackages)
        {
            this.proj = new Self.Project (root, excludeRootPackages);
