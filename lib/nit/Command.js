    ...
    return (Self = nit.defineClass ("nit.Command"))
        ...
        .staticMethod ("help", function ()
        {
            ...
            help
                ...
                .paragraph ("Usage: nit "
                    + nit.ComponentDescriptor.get (cmd).name
            ...
            if (pargs.length)
            {
                help.table (pargs.map (p =>
                {
                    ...
                    [
                        " " + p.helpSpec,
                        p.description,
                        nit.is.empty (defval) ? "" : "[default: " + defval + "]"
                    ];
            ...
            if (opts.length)
            {
                help.table (opts.map (p =>
                {
                    ...
                    [
                        ...
                        p.description,
                        (p.type == "boolean" || nit.is.empty (defval)) ? "" : "[default: " + defval + "]"
                    ];
        ...
        .defineInnerClass ("Type", Type =>
        {
            Type
                ...
                .method ("lookup", async function ()
                {
                    return await nit.lookupCommand (this.name);
                })
            ;
        })
