        ...
        .configureComponentMethods ("run", function (Queue)
        {
            Queue
                .onInit (function (cmd)
                {
                    ...
                    ctx = ctx instanceof cls.Context ? ctx : cls.Context.new (cls.Input.fromArgv (...this.args));
                    ctx.command = cmd;
