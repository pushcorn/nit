    ...
    return (Self = nit.defineClass ("nit.Command"))
        ...
        .defineInnerPlugin ("CommandPlugin", CommandPlugin =>
        {
            CommandPlugin
                ...
                .method ("preRun", /* istanbul ignore next */ function (ctx, cmd) {}) // eslint-disable-line no-unused-vars
                .method ("postRun", /* istanbul ignore next */ function (ct, cmd) {}) // eslint-disable-line no-unused-vars
