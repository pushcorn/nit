module.exports = function (nit, Self)
{
    return (Self = nit.defineClass ("nit.Command"))
        ...
        .categorize ("commands")
        .registerTypeParser (new nit.Object.PrimitiveTypeParser ("command", "", function (v) { return nit.Object.PrimitiveTypeParser.valueToString (v); }))
        .defineInnerClass ("completers.Command", "nit.compgen.Completer", Completer =>
        {
            Completer
                .onCompleteForType (function (ctx)
                {
                    ...
                    if (type == "command" || type == "nit.Command")
                    {
        ...
        .defineInnerClass ("Input", Input =>
        {
            Input
                ...
                .staticMethod ("parseArgv", function (argv)
                {
                    ...
                    {
                        value = opt.primitive ? value : nit.toVal (value);
