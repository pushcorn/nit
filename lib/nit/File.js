module.exports = function (nit, Self)
{
    return (Self = nit.defineClass ("nit.File"))
        ...
        {
            nit.fs.writeFileSync (this.absPath, content, Self.encodingForContent (content, encoding));
        })
        .method ("writeAsync", async function (content, encoding)
        {
            await nit.fs.promises.writeFile (this.absPath, content, Self.encodingForContent (content, encoding));
        })
    ;
};
