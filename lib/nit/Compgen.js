module.exports = function (nit, Self)
{
    return (Self = nit.defineClass ("nit.Compgen"))
        ...
        .constant ("REDIRECT_PATTERN", /^([<>]|[0-9]+[&<>]+|[&<>]+[0-9]+)$/)
        ...
        .defineInnerClass ("DummyCommand", "nit.Command")
        .defineInnerClass ("DummySubcommand", "nit.Subcommand", Subcommand => Subcommand.defineInput ())
            ...
            Context
                ...
                .field ("currentCommand", "string", "The current command that's being completed.",
                {
                    setter: function (command)
                    {
                        ...
                        {
                            this.commandClass = Self.DummyCommand;
                        }
                ...
                .field ("currentSubcommand", "string", "The current subcommand that's being completed.",
                {
                    setter: function (subcommand)
                    {
                        ...
                        {
                            this.subcommandClass = subcommand ? Self.DummySubcommand : undefined;
                        }
