            ...
            Context
                ...
                .field ("currentSubcommand", "string", "The current subcommand that's being completed.",
                {
                    setter: function (subcommand)
                    {
                        try
                        {
                            let category = this.subcommandOption.class.subcommandCategory;

                            this.subcommandClass = nit.lookupComponent (subcommand, category, "nit.Subcommand");
                        }
                        catch (e)
                        {
